...
export default function App() {
  ...
  if (role === "staff" && isAuthenticated) {
    const onNavigate = (page, data) => {
      ...
      if (data?.prefillStudent) setSelectedItem(data);
      else if (data && !data.item && !data.prefillStudent) setSelectedItem(data);
      setCurrentPage(page);
    };
    ...
    return (
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-4">
          ...
          {currentPage === "fines" && <ManageFines {...shared} prefillData={selectedItem?.prefillStudent} />}
